-- Lsp configurations
return {
  { -- sets up lua lsp for nvim stuff
    'folke/lazydev.nvim',
    lazy = true,
    ft = 'lua',
    opts = {
      library = {
        --       "~/projects/my-awesome-lib", -- Library paths can be absolute
        --       "lazy.nvim", --       -- Or relative, which means they will be resolved from the plugin dir.
        --       -- It can also be a table with trigger words / mods
        --       -- Only load luvit types when the `vim.uv` word is found
        --       { path = "${3rd}/luv/library", words = { "vim%.uv" } },
        --       "LazyVim",  -- always load the LazyVim library
      ...
      --     end,
      --       library = { -- from the kickstart.nvim
  ...
  { -- main lsp configuration
    ...
    config = function()
      -- bad stuff start
      require('mason-tool-installer').setup({ -- isntalltion
        'lua-language-server',
        'stylua',
        'luacheck',
        auto_update = true,
      ...
      -- set up handlers method w/ 'lspconfig'
      -- use fidget.nvim to notify
      -- bad stuff edn

      -- do something when i attach slp
      ...
      --       }
      --
      --local capabilities = require('blink.cmp').get_lsp_capabilities() -- broadcast capabillies to lsp
...
--   use mason-tools to install prettier and rsut andalyzer and so on
